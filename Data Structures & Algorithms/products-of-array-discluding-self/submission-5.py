...
class Solution:
    def productExceptSelf(self, nums: List[int]) -> List[int]:
        ...
        ## now doing it optimal. too many new arrays. can we ethically compute the pre and suffix without needing the 2 arrays? yes. in res do prefix. create another loop and do suffix
        n = len(nums)
        res = n * [0]
